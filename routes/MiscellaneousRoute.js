...
router.route("/updateMiscBanner").patch(
  // isAuthorizedUser,
...
router.route("/updateLandBanner").patch(
  // isAuthorizedUser,
  // authorizedRoles("admin"),
  singleUpload,
  addLandBanner
...
router.route("/addMiscProduct").post(
  // isAuthorizedUser,
  // authorizedRoles("admin"),
  singleUpload,
  addMiscProduct
);
router.route("/addLandProduct").post(
  // isAuthorizedUser,
  // authorizedRoles("admin"),
  singleUpload,
  addLandProduct
...
router.route("/updateMiscProducts/:id").put(
  // isAuthorizedUser,
  // authorizedRoles("admin"),
  singleUpload,
  miscUpdateProduct
...
router.route("/updateLandProducts/:id").put(
  // isAuthorizedUser,
  // authorizedRoles("admin"),
  singleUpload,
  landUpdateProduct
);
router.route("/productLand/:id").delete(
  // isAuthorizedUser, authorizedRoles("admin"),
  landDeleteProduct
);
// poduct controller route
